...
class NuevaCita extends Component {
    state = { ...stateInicial }
     ...
     handleChange = e => {
         ...
         this.setState({
             cita : {
                 // Se hace una copia del state, para que los datos previos no se borren
                 ...this.state.cita,
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={this.handleSubmit}>
                        <div className="form-group row">
                            <label className="col-sm4 col-lg-2 col-form-label">Nombre Mascota</label>
                        ...
                        <div className="form-group row">
                            <label className="col-sm4 col-lg-2 col-form-label">Nombre Dueño</label>
                            <div className="col-sm-8 col-lg-10">
                                <input 
                                    type="text"
                                    className="form-control"
                        ...
                        <div className="form-group row">
                            <label className="col-sm4 col-lg-2 col-form-label">Síntomas</label>
                            <div className="col-sm-8 col-lg-10">
                                <textarea 
                                    className="form-control" 
                                    name="sintomas"
